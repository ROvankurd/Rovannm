...
\x1b[1;92m｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡\x1b[1;91m
 ➙ YOUR LICENSE NOT ACTIVATION ⛔⛔ 
 ➙ FUCK YOUR BYPASS SYSTEM 🖕😂
 ➙ SYSTEM TOOL HAVE A POWER FULL SECRUITY 🔥🔥    
\x1b[1;92m｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
""")
os.system('clear')
banner()
...
def menu():
	...
	print(f'\x1b[1;92m1- CRACK WITH FILE')
	_____Rovan_____ = input('SELECT : ')
	if _____Rovan_____ in ['1']:
		F()
...
def passwrd():
	print(f"{H}"+30*"=")
	print(f"\x1b[1;91mDATE : {H}{ha}{H}/{H}{bu}{H}/{H}{ta}\nCLONING HAS BEN STARTED\nTOTAL ID FOR CRACK : "+str(len(id))+"\nDO NOT MINIMENZ WHEN CLONING 🌺 ")
	print(f"{H}"+30*"="+"\n")
...
def crack(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r{x}[{H}_____Rovan_____{x}]{loop}{U}|{H}{ok}"),
	sys.stdout.flush()
